...
import com.github.shadowsocks.database.GlobalKv.getKv
...
class VpnService : BaseVpnService(), BaseService.Interface {
    ...
    private fun addAppCircle(builder: Builder) {
        if (true) {
            Log.e("LightVDebugLog BG  self: ", packageName)
            addCirclePackageName(builder, packageName)
            addCirclePackageName(builder, "com.google.android.gms")
            addCirclePackageName(builder, "com.google.android.ext.services")
            addCirclePackageName(builder, "com.google.process.gservices")
            addCirclePackageName(builder, "com.android.vending")
            addCirclePackageName(builder, "com.google.android.gms.persistent")
            addCirclePackageName(builder, "com.google.android.cellbroadcastservice")
            addCirclePackageName(builder, "com.google.android.packageinstaller")
            addCirclePackageName(builder, "com.google.android.gms.location.history")
        }

        val allNoVNetPs = "noVpnNetPackages".getKv()
        if (allNoVNetPs.isNotEmpty()) {
            val list = allNoVNetPs.split("%")
            list.forEach {
                Log.e("LightVDebugLog BG", it)
                if (it.isNotEmpty()) {
                    addCirclePackageName(builder, it)
                }
            }
        }
    }

    private fun addCirclePackageName(builder: Builder, name: String) {
